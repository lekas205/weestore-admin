        ...
        <div class="title-container">
          <div class="title tw-flex tw-gap-[50px] tw-justify-center mt-5">
            <p
              ...
              :class="{
                'tw-underline tw-text-[#000000]': returnType === 'half',
              }"
            >
              Half return
            </p>
            <p
              ...
              class="tw-font-[700] tw-text-[20px] tw-text-[#A5A1A8] tw-cursor-pointer"
              :class="{
                'tw-underline tw-text-[#000000]': returnType === 'full',
              }"
            >
              Full Return
            </p>
                ...
                <v-col cols="12" md="9">
                  ...
                  <p
                    ...
                    v-if="
                      ...
                      formData.orders[index].initial_quantity
                    "
                  >
                    {{
                      `Sorry quatity can't be increased above ${formData.orders[index].initial_quantity}`
                    }}
                  </p>
                </v-col>
              </v-row>
